      ...
      >
        <form id="upload-doc-form-admin" onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-2">
            <Label htmlFor="admin-doc-file">File <span className="text-red-500">*</span></Label>
            <div
          ...
          <div className="space-y-2">
            <Label htmlFor="admin-doc-title">Title</Label>
            <Input
              id="admin-doc-title"
          ...
          <div className="space-y-2">
            <Label htmlFor="admin-doc-category">Category</Label>
            <Select value={form.category} onValueChange={(v) => setForm((f) => ({ ...f, category: v }))}>
              <SelectTrigger id="admin-doc-category"><SelectValue /></SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-2">
            <Label htmlFor="admin-doc-desc">Description</Label>
            <Textarea
              id="admin-doc-desc"
