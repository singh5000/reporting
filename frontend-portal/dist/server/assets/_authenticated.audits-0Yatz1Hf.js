...
function AuditsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-[1400px] space-y-5 animate-in fade-in duration-300", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(FilterBar, { search, onSearchChange: setSearch, searchPlaceholder: "Search audits…", filters: FILTER_CONFIGS, values: filterVals, onFilterChange: (key, val) => setFilterVals((prev) => ({
        ...prev,
        [key]: val
      })), onClear: () => {
        setSearch("");
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ModuleDrawer, { open: drawerOpen && can("audit:create"), onOpenChange: setDrawerOpen, title: "New Audit", description: "Create a new compliance audit", size: "md", footer: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { form: "create-audit-form", type: "submit", disabled: submitting || !form.title, className: "[background:var(--gradient-primary)] text-primary-foreground hover:brightness-110", children: submitting ? "Creating…" : "Create Audit" })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Textarea, { id: "audit-desc", placeholder: "Describe the scope and objectives…", rows: 3, value: form.description, onChange: (e) => setForm((f) => ({
          ...f,
