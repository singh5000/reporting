...
function PPEPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-[1400px] space-y-5 animate-in fade-in duration-300", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(FilterBar, { search, onSearchChange: setSearch, searchPlaceholder: "Search PPE itemsâ€¦", filters: FILTER_CONFIGS, values: filterVals, onFilterChange: (key, val) => setFilterVals((prev) => ({
        ...prev,
        [key]: val
      })), onClear: () => {
        setSearch("");
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ModuleDrawer, { open: drawerOpen && can("ppe:create"), onOpenChange: setDrawerOpen, title: "Add PPE Item", description: "Register new personal protective equipment", size: "md", footer: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { form: "create-ppe-form", type: "submit", disabled: submitting || !form.name, className: "[background:var(--gradient-primary)] text-primary-foreground hover:brightness-110", children: submitting ? "Addingâ€¦" : "Add Item" })
